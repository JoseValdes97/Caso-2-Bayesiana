...
```{r}
# Gráfico
plot(cadena1_M1$LL$ll, type = "p", pch = ".", cex = 1.1, col = "cyan", xlab = "Iteración",ylab = "Log-verosimilitud", main = "Modelo 1")
```
...
```{r}
# Gráfico
plot(cadena1_M2$LL$ll, type = "p", pch = ".", cex = 1.1, col = "magenta",  xlab = "Iteración",ylab = "Log-verosimilitud", main = "Modelo 2")
```
...
```{r}
# Gráfico
plot(cadena1_M3$LL$ll, type = "p", pch = ".", cex = 1.1, col = "red", ylim = c(-5720,-5540),  xlab = "Iteración",ylab = "Log-verosimilitud", main = "Modelo 3")
```
...
```{r}
# Gráfico
plot(cadena1_M4$LL$ll, type = "p", pch = ".", cex = 1.1, col = "lightblue",  xlab = "Iteración",ylab = "Log-verosimilitud", main = "Modelo 4")
```
...
```{r}
# Gráfico
plot(cadena1_M5$LL$ll, type = "p", pch = ".", cex = 1.1, col = "darkblue", ylim = c(-5530,-5590),  xlab = "Iteración",ylab = "Log-verosimilitud", main = "Modelo 5")
```
...
```{r}
# Gráfico
plot(cadena1_M6$LL$ll, type = "p", pch = ".", cex = 1.1, col = "darkgreen", xlab = "Iteración",ylab = "Log-verosimilitud", main = "Modelo 6")
```
...
par(mfrow = c(1,2))
#modelos normal
plot(cadena1_M1$LL$ll, type = "p", pch = ".", cex = 1.1, col = "cyan", ylim=c(-5920,-5580), xlab = "Iteración",ylab = "Log-verosimilitud", main = "Modelos Normales")
lines(cadena1_M2$LL$ll, type = "p", pch = ".",col = "darkblue")
lines(cadena1_M3$LL$ll, type = "p", pch = ".",col = "gold")
#modelos t
plot(cadena1_M4$LL$ll, type = "p", pch = ".", cex = 1.1, col = "lightblue", ylim = c(-5720,-5540),  xlab = "Iteración",ylab = "Log-verosimilitud", main = "Modelos t")
lines(cadena1_M5$LL$ll, type = "p", pch = ".",col = "magenta")
lines(cadena1_M6$LL$ll, type = "p", pch = ".",col = "darkgreen")
```
